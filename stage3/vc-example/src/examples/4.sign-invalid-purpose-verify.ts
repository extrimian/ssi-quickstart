...
export const signInvalidPurpose = async () => {
    const credential = {
        "@context": [
    ...
    const vc = await kms.signVC(Suite.Bbsbls2020,
        ...
        "did:modena:matic:EiDxVyreUxU_nBYhtifpAXC7PcgMJ3DLkl_1Vdxy0Izg0w#bbsbls-2",
        new AssertionMethodPurpuse()); // AssertionMethodPurpose is OK
